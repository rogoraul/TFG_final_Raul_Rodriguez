...
\begin{enumerate}
    ...
    \textit{look-ahead}, entendidos como el uso de informaci\'on que todav\'ia no
    estar\'ia disponible en una revisi\'on real, de forma que las se\~nales se
    eval\'uen solo con la informaci\'on que habr\'ia estado disponible en cada
    momento.
