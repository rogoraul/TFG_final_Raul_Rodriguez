...
- exclusion_reason_validity: not_excluded
- recommended_policy_adjustment: keep_policy
- visual_notes: Policy keeps the case in a non-operational bucket consistent with prior visual/context labels.
...
- final_soft_quality_score: 51
- visual_policy_verdict: policy_correct
- exclusion_reason_validity: probably_valid_exclusion
- recommended_policy_adjustment: keep_policy
- visual_notes: Low prominence and short duration make it unsafe as primary H4/D1 seed.
...
- exclusion_reason_validity: probably_valid_exclusion
- recommended_policy_adjustment: keep_policy
- visual_notes: Exclusion is consistent with conservative policy composition.
...
- visual_policy_verdict: policy_correct
- exclusion_reason_validity: valid_exclusion
- recommended_policy_adjustment: keep_policy
- visual_notes: Exclusion follows an explicit visual negative / false-positive / misleading context label.
...
- visual_policy_verdict: policy_too_lenient
- exclusion_reason_validity: not_excluded
- recommended_policy_adjustment: increase_prominence_penalty
- visual_notes: Chart inspection shows the kept H4/D1 structure is very small against the visible window; it should not remain a strong provisional seed without a stronger prominence penalty.
